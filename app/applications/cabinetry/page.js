  ...
  return (
    <div>
      ...
      <Container>
        ...
        Structural integrity and the overall aesthetic
        </h2>
            ...
            <div className="flex-col flex gap-4 md:col-span-3">
              <div>
                <h2 className="leading-7 ">
                  Shorus we manufacture a huge selection of panels suitable for
                  cabinetry ranging from natural veneers to UV treated gloss finish, depending on the level of strength needed for the project the core can be MDF or plywood, we offer a high level of customizationation where our client can choose the glue, veneer, core species and size.
                </h2>
              </div>
              ...
              <h4 className="scroll-m-20 text-xl font-semibold tracking-tight mt-6 ">
                Explore the possibilities and advantages of cabinetry
                paneling:
              </h4>
                  ...
                  <div className="py-6">
                    ...
                    <div className="flex flex-col gap-4 md:flex-row">
                      ...
                      <Link href={"/products/plywood/engineeredfancyplywood"}>
                        <Image
                          src={hpl}
                          alt="photo of osb with colorful HPL panel"
                        />
